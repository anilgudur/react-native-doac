    ...
    return (
      ...
      <View style={css.intro_screen.container}>
...

        {
          ...
          <View style={{
            position: "absolute", top: 0, right: 0, alignItems: "center", justifyContent: "center"
            //backgroundColor: "rgba(0,0,0,.2)" 
          }}>
            <Icon
              //onPress={() => navigate('HomeRoute', { param1: 'From Intro Slider' })}
              onPress={() => dispatch(NavigationActions.reset({index: 0, actions: [ NavigationActions.navigate({ routeName: 'HomeRoute'}) ] })) }
              //reverse
              name='highlight-off'
